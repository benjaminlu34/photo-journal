...
export function JournalWorkspace() {
  ...
  if (!currentEntry) {
    return (
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-primary-25 to-secondary-50">
  ...
  return (
    <div
      ...
      className={`flex-1 relative overflow-auto bg-gradient-to-br from-primary-25 to-secondary-50 ${
