...
describe('Profile Username Management', () => {
  ...
  describe('Username Change Tracking', () => {
    it('should track username changes in audit table', async () => {
      ...
      const updatedUser = await storage.updateUserWithJWTSync('test-profile-user', {
      ...
      const retrievedUser = await storage.getUser('test-profile-user');
    ...
    it('should handle profile updates without username changes', async () => {
      ...
      const updatedUser = await storage.updateUser('test-profile-user-2', {
        firstName: 'Updated',
        lastName: 'Name'
      });
    ...
    it('should validate username format during profile updates', async () => {
      ...
      const updatedUser = await storage.updateUser('test-profile-user-3', {
